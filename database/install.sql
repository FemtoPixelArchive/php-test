CREATE USER 'exam'@'localhost' IDENTIFIED BY  'exam';
GRANT USAGE ON * . * TO  'exam'@'localhost' IDENTIFIED BY  'exam' WITH MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS 0 ;
CREATE DATABASE IF NOT EXISTS  `exam` ;
GRANT SELECT ON  `exam` . * TO  'exam'@'localhost';
